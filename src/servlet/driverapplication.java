...
/**
 * Servlet implementation class driverapplication
 */
@WebServlet("/driverapplication")
public class driverapplication extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fullpath = editpath + "human safty\\WebContent\\Locals\\";
		...
		if (filename.endsWith(".txt")) {// if open
			...
			try {// try1 open
				...
				filepath1 = editpath + "\\human safty\\WebContent\\Encrypt\\" + filename;
				...
				filepath2 = editpath + "\\human safty\\WebContent\\Decrypt\\" + filename;
		...
		drapplication bu = new drapplication();
		bu.setFname(paramValues.get(0).toString());
		System.out.println("Date:" + paramValues.get(0).toString());

		bu.setLname(paramValues.get(2).toString());
		System.out.println("Name:" + paramValues.get(2).toString());

		bu.setEmail(paramValues.get(4).toString());
		System.out.println("Email:" + paramValues.get(4).toString());

		bu.setGender(paramValues.get(6).toString());
        System.out.println("Address:" + paramValues.get(6).toString());
		
		bu.setVillage(paramValues.get(8).toString());
		System.out.println("Location:" + paramValues.get(8).toString());
	
		bu.setCity(paramValues.get(10).toString());
		System.out.println("productname:" + paramValues.get(10).toString());
	/*	
		bu.setPrice(paramValues.get(12).toString());
		System.out.println("price:" + paramValues.get(12).toString());

		bu.setPtype(paramValues.get(14).toString());
		System.out.println("Ptype:" + paramValues.get(14).toString());*/

		bu.setImage(filename);

		imple pdtt = new imple();
		int pt = pdtt.drapplication(bu);
